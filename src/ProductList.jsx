...
const ProductList = () => {
  ...
  const isPlantAdded = (plant) => {
    return cartItems.some((item) => item.name === plant);
  };
    ...
    <div>
      <div className="navbar" style={styleObj}>
        ...
        <div style={styleObjUl}>
          ...
          <div>
            {" "}
            <a href="/cart" style={styleA} onClick={(e) => handleCartClick(e)}>
              <h1 className="cart">
                <svg
              ...
              <div className="product-list">
                {category.plants.map((plant, plantIdx) => (
                  <div className="product-card" key={plantIdx}>
                    ...
                    <button
                      className={`product-button ${isPlantAdded(plant.name) ? "added-product" : ""}`}
                      onClick={() => handleAddToCart(plant)}
                      disabled={isPlantAdded(plant.name)}
                    >
